...
class Boggle():
    ...
    # we use self inside of the function so that we can use some of the attributes and 
    # methods stored inside of the class
    def __init__(self):

        # read_dict is a function that is used later in the code. The function accepts
        # one parameter and this is called dict_path. Our dict_path is the 
        # words.txt file. 

        # this function is giving the variable nbame self.words to refer to this 
        # dictionary of potential words. 
        self.words = self.read_dict("words.txt")

    # read_dict is a function that has self as a parameter which means its attributes and 
    # methods can be used. It also has a dict_path parameter that it takes in. The starter
    # code has already shown us that the value that we are placing inside of dict_path
    # is going to be the words.txt file
    def read_dict(self, dict_path):
        """Read and return all words in dictionary."""

        # the open() function opens a file and returns it as a file object. 
        # dict_file is the name were assigning this opened file which is the words.txt file.
        dict_file = open(dict_path)

        # for loop that is going to loop through all the words invididually inside of the 
        # dictionary we have and remove any white space before or after the word. Assigning
        # this to the variable named words
    ...
    def make_board(self):
        ...
        # for 0, 1, 2, 3, 4. Make rows with 5 random letters in it from A-Z
        for y in range(5):

            # this is a list. choice() was imported from the random class and 
            # what it does is choose something at random. string.ascii_uppercase
            # is a string consisting of the letters A-Z all in uppercase. 

            # choice(string.ascii_uppercase) chooses a random uppercase letter A-z and the 
            # for loop makes it choose 5 of these random letters.
